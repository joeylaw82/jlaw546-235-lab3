...
def test_illegal_move_facing_south(robot):
    robot.turn()
    robot.turn()
...
def test_illegal_move_facing_west(robot):
    robot.turn()
    robot.turn()
    robot.turn()
...
def test_illegal_move_facing_east(robot):
    robot.turn()
    for i in range(9):
        robot.move()
...
def test_illegal_move_facing_north(robot):
    for i in range(9):
        robot.move()
